		...
		<tr>
			<td style="width:70%;">
				<div style='color:#fff;border-radius: 15px;padding: 20px;background-image:url(<?php echo esc_url($m); ?>);background-size: 140% 120%;background-position:center center;background-repeat: no-repeat;overflow:hidden;'>
					...
					<h3 style='color:#FFC525;font-size:16px;font-weight:normal;margin:0 0 8px;letter-spacing:0.5px;'><strong style='color:#fff;'><?php echo __('To:', 'event-tickets-manager-for-woocommerce'); ?> </strong>[NEW_END_DATE]</h3>
					<h3 style='color:#FFC525;font-size:16px;font-weight:normal;margin:0;letter-spacing:0.5px;'><strong style='color:#fff;'><?php echo __('Venue:', 'event-tickets-manager-for-woocommerce'); ?> </strong>[VENUE]</h4>
				</div>
			</td>
			<td style="width:30%;">
