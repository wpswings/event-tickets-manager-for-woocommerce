		...
		<tr>
			...
			<td style="width:70%;padding:0 0 0 10px;border:1px solid #bc8a00;">
				<div style='color:#000;padding: 20px;'>
					...
					<h3 style='color:#bc8a00;font-size:16px;font-weight:normal;margin:0 0 8px;letter-spacing:0.5px;'><strong style='color:#000;'><?php echo __('From:', 'event-tickets-manager-for-woocommerce'); ?> </strong>[NEW_START_DATE]</h3>
					<h3 style='color:#bc8a00;font-size:16px;font-weight:normal;margin:0 0 8px;letter-spacing:0.5px;'><strong style='color:#000;'><?php echo __('To:', 'event-tickets-manager-for-woocommerce'); ?> </strong>[NEW_END_DATE]</h3>
					<h3 style='color:#bc8a00;font-size:16px;font-weight:normal;margin:0;letter-spacing:0.5px;'><strong style='color:#000;'><?php echo __('Venue:', 'event-tickets-manager-for-woocommerce'); ?></strong>[VENUE]</h4>
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style='padding: 20px 0 0;background: #fff;'>
				<div style='padding: 20px;background: #bc8a00;'>
					<h4 style='color:#fff;font-weight:bold;font-size:18px;margin:0 0 5px;letter-spacing:0.5px;line-height:1;'><?php echo __('Note:', 'event-tickets-manager-for-woocommerce'); ?></h4>
