...
?>
			...
			if (isset($_POST['upload_csv'])) {
				if (!empty($_FILES['csv_file']['tmp_name'])) {
					...
					for ($i = 1; $i < count($csv_data); $i++) {
						...
						// Create order.
						$order_id = $this->create_order_from_csv($product_id, $wps_order_note, $customer_id, $quantity, $custom_meta_value, $billing_address, $billing_email, $billing_phone);
					}
				}
			}
		}
		...
		function create_order_from_csv($product_id, $wps_order_note, $customer_id, $quantity, $custom_meta_value, $billing_address, $billing_email, $billing_phone)
		{
			...
			// $order->update_status( 'completed', 'pending', TRUE); 
