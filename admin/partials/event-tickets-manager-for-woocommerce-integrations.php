...
$tab_context                = Event_Tickets_Manager_For_Woocommerce_Admin_UI::get_tab_context( 'event-tickets-manager-for-woocommerce-integrations' );
?>
<?php
Event_Tickets_Manager_For_Woocommerce_Admin_Layout::render_settings_card(
	array(
		...
		'form_class'        => 'wps-etmfw-integration-section-form',
		'fields'            => $etmfw_integration_settings,
