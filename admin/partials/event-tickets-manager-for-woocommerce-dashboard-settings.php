...
$etmfw_dashboard_settings = apply_filters( 'wps_etmfw_dashboard_settings_array', array() );
$tab_context              = Event_Tickets_Manager_For_Woocommerce_Admin_UI::get_tab_context( 'event-tickets-manager-for-woocommerce-dashboard-settings' );
?>
<?php
Event_Tickets_Manager_For_Woocommerce_Admin_Layout::render_settings_card(
	array(
		...
		'form_class'        => 'wps-etmfw-dashboard-section-form',
		'fields'            => $etmfw_dashboard_settings,
