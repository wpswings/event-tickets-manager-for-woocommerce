...
##  WHAT IS INCLUDED IN THE FREE EVENT TICKETS MANAGER PLUGIN

**1) Enable/Disable Shipping Charges**

With WordPress Events Plugins, the admins get a chance to decide whether he wants a certain event/item to have shipping charges inclusive or not. They get a chance to enable/disable the shipping charges. 

**2) My Event Tab in My Account Section**
...
**7) Set Location For Events With Google Maps**
...
**10) Edit Your Ticket Content With A Breeze**
...
**11) Validate Event Check-in Using Emails**
...
Thus, making Events plugin WordPress one of the best online ticketing solutions and event management plugins in WordPress for eCommerce websites.
