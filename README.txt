...
==  WITH THE WORPRESS EVENTS PLUGIN YOU CAN: ==
...
* With the events ticket plugin, send the tickets as PDF to customers in an email.
...
* Create an event management and ticketing for events system with WooCommerce.
...
== WHAT IS INCLUDED IN FREE EVENT TICKETS PLUGIN ==

**1) Enable/Disable Shipping Charges**
With WordPress Events Plugins, the admins gets a chance to decide whether he wants a certain event/item to have shipping charges inclusive or not. They get a chance to enable/disable the shipping charges. 

**1) My Event Tab in My Account Section**
The WooCommerce Event Manager plugin allows a separate section for the users to see their personal orders and to list the purchased tickets of the client. Customers can check their purchased events in the "My Events" tab in the "My Account" section to give their customers a more personalized experience.

**2) Hide/Remove Expired Event**
Event Tickets Plugin removes the expired event from the account to keep your customers updated. Removed events can be recovered from the Trash section. Expired Event is permanently deleted when you clear your trash section.
...
**6) Set Location For Events With Google Maps**
The Event Manager Plugin, provides a high-level view of your offline events with event manager WordPress by showing the exact location of events to the user in the frontend. The plugin is integrated with Google Maps and lets WooCommerce store owners show the live location of the events on their store.

**7) Download Tickets As PDF**
The WooCommerce Event Tickets Manager allows the customer to download the tickets as PDFs for offline use. When customers buy event tickets for an event from your WooCommerce store they send an email with a pdf attachment of the ticket. The customers can also download the ticket from the **My Account tab.**

**8) Events Calendar**
The Events Ticket Manager comes with an interactive calendar widget. The widget shows your customers the names of upcoming, past, and present ongoing events in the form of a list or grid via an event calendar.

**9) Edit Your Ticket Content With A Breeze**
The WooCommerce Event Plugin gives merchants an easy-to-use editor to update the content of the tickets mailed to customers. You can very easily edit the subject and the main body of your WooCommerce event tickets. The editor also lets you use the shortcode to insert the name of your site in emails.

**10) Validate Event Check-in Using Emails**
The users have to use the email address on which they received the ticket. By entering their email addresses users can validate their check-in for the events they are planning to participate in.

**11) WPML Multilingual Support**
The Event Ticket System Plugin comes with [**WPML**](https://wpml.org/purchase/) multilingual support, so to say, the WooCommerce extension will work in your local language. You can also use the Loco Translate Plugin to translate the string into your local language.
...
WooCommerce Event Tickets plugin allows customers for an easy check-in process by using QR Code. 

**2) Fully Customizable PDF Tickets**

We have now introduced fully customizable PDF tickets. This allows the users to create event tickets the way they want.

**3) Multiple Layouts for Tickets PDFs:**

The WooCommerce Events Plugin now offers a feature that allows users to select from multiple layout options for ticket PDFs when creating and managing events.

**4) Send Ticket Details with SMS:**

Merchants can assure that the customers have received their products by tracking SMSs.

**5) Facebook Sharing of Tickets**
...
== TAKE ADVANTAGE OF EXCLUSIVE FEATURES OF THE WOOCOMMERCE EVENTS PLUGIN ==
...
* Feature: Setting for Disable the Shipping Charge on Event Product Page.
