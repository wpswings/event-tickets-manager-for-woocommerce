...
<body style="background-color: #ffffff; margin: 0; box-sizing: border-box;">
  <table cellspacing="0" cellpadding="0" style="width: 900px; background-color: <?php echo esc_attr( $bg_color ); ?>; margin: 0 auto;">
	<tbody>
	  <tr>
		<td style="width: 25%; padding: 15px; box-sizing: border-box;"><img id = "wps_logo_image" src="https://d27jswm5an3efw.cloudfront.net/app/uploads/2019/08/image-url-3.jpg" style="width: 180px;margin-left: 25px"></td>
		<td style="width: 50%; box-sizing: border-box;">
					<table style="width: 100%; padding: 15px 15px; border-left: dashed 2px #B3B9C2;">
						<tr>
							<td colspan="2">
								<h1 style="margin: 0; font-size: 24px; color: <?php echo esc_attr( $text_color ); ?>;">Album JIO</h1>
							</td>
						</tr>
						<tr>
							<td>
								<p style="margin: 0; margin-top: 10px; margin-bottom: 10px; color: <?php echo esc_attr( $text_color ); ?>; font-size: 16px;">Venue- <br><span style="color:<?php echo esc_attr( $text_color ); ?>">Delhi</span></p>
							</td>
							<?php if ( true != $wps_is_qr_is_enable ) { ?>
							<td>
								<p style="margin: 0; margin-top: 10px; color: <?php echo esc_attr( $text_color ); ?>; font-size: 16px;">Ticket- <br><span style="color:<?php echo esc_attr( $text_color ); ?>">7ENBI</span></p>
							</td>
							<?php } ?>
						</tr>
						<tr>
						...
						<tr>
							<td style="padding-bottom: 10px; color: <?php echo esc_attr( $text_color ); ?>;">April 12,2023 1:23pm</td>
						...
						<tr>
							<td style="padding-bottom: 10px; color: <?php echo esc_attr( $text_color ); ?>;">April 28,2023 12:00am</td>
							<!-- <td style="padding-bottom: 10px; color: #1E1E1E;">12:00 am</td> -->
						</tr>
					</table>
		</td>
					<td style="width: 25%; padding: 0; vertical-align: top; text-align: center; box-sizing: border-box; background-image: url(<?php echo esc_url( EVENT_TICKETS_MANAGER_FOR_WOOCOMMERCE_DIR_URL . 'admin/src/images/qr-bg.png' ); ?>); background-size: cover;">
