	  ...
	  <tr>
		...
		<td style="width: 50%; box-sizing: border-box;">
					<table style="width: 100%; padding: 15px 15px; border-left: dashed 2px #B3B9C2;">
						...
						<tr>
							<td>
								<p class="wps_etmfw_pdf_text_colour" style="margin: 0; margin-top: 10px; margin-bottom: 10px; color: <?php echo esc_attr( $wps_etmfw_text_color ); ?>; font-size: 16px;">Venue- <br><span class="wps_etmfw_pdf_text_colour" style="color:<?php echo esc_attr( $wps_etmfw_text_color ); ?>">Delhi</span></p>
							</td>
							<?php if ( true != $wps_is_qr_is_enable ) { ?>
							<td>
								<p class="wps_etmfw_pdf_text_colour" style="margin: 0; margin-top: 10px; color: <?php echo esc_attr( $wps_etmfw_text_color ); ?>; font-size: 16px;">Ticket- <br><span class="wps_etmfw_pdf_text_colour" style="color:<?php echo esc_attr( $wps_etmfw_text_color ); ?>">7ENBI</span></p>
							</td>
							<?php } ?>
						</tr>
						<tr>
					...
					<table style="100%; box-sizing: border-box; padding: 15px 20px;">
						<tr>
							<td id = "wps_etmfw_parent_wrapper_3" class="wps_etmfw_pdf_text_colour  wps_etmfw_ticket_body" style="background-color:#65C7D7;padding: 5px 15px;border-radius: 5px;text-align: center;color: <?php echo esc_attr( $wps_etmfw_text_color ); ?>; background-color:white;">Your Ticket</td>
						</tr>
						<tr>
							...
							<?php } else { ?>
							<h3 class="wps_etmfw_pdf_text_colour" style="margin-left: 2px;margin-top: 39px; color: <?php echo esc_attr( $wps_etmfw_text_color ); ?>;">FENBI</h3>
							<?php } ?>
						</td>
						</tr>
					</table>
