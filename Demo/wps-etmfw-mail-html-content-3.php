...
<body style="background-color: #ffffff; margin: 0; box-sizing: border-box;">
  <table cellspacing="0" cellpadding="0" style="width: 900px; background-color: <?php echo esc_attr( $bg_color ); ?>; margin: 0 auto;">
	<tbody>
	  <tr>
		<td style="width: 25%; padding: 15px; box-sizing: border-box;"><img src="https://d27jswm5an3efw.cloudfront.net/app/uploads/2019/08/image-url-3.jpg" style="width: 180px;margin-left: 25px"></td>
					...
					<tr>
						<td>
							<table style="width: 80%; padding: 15px 15px; border-right: dashed 2px #ffffff; margin: 0 auto">
								<tr>
									<td colspan="2">
										<h1 style="margin: 0; font-size: 24px; color: <?php echo esc_attr( $text_color ); ?>; text-align: center;">Album JIO</h1>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<p style="margin: 0; margin-top: 10px; margin-bottom: 10px; color: #FFFFFF; font-size: 16px; text-align: center;">Venue- <span style="color:<?php echo esc_attr( $text_color ); ?>">Delhi</span></p>
									</td>
								</tr>
								<tr>
								...
								<?php if ( true != $wps_is_qr_is_enable ) { ?>
									<td colspan="2">
										<p style="margin: 0; margin-top: 10px; color:<?php echo esc_attr( $text_color ); ?>; font-size: 16px; text-align: center;">Ticket- <span style="color:<?php echo esc_attr( $text_color ); ?>;">7ENBI</span></p>
									</td>
									<?php } ?>
								</tr>
							</table>
