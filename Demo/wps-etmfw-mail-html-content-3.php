...
<body style="background-color: #ffffff; margin: 0; box-sizing: border-box;">
  <table class="wps_etmfw_border_color wps_etmfw_ticket_body" id = "wps_etmfw_parent_wrapper" cellspacing="0" cellpadding="0" style="width: 900px; background-color:  <?php echo esc_attr( $wps_etmfw_background_color ); ?>; margin: 0 auto;border:2px <?php echo get_option('wps_etmfw_border_type').' ' . get_option('wps_etmfw_pdf_border_color'); ?>">
	<tbody>
	  <tr>
		<td style="width: 25%; padding: 15px; box-sizing: border-box;"><img id = "wps_wem_logo_id" src='<?php echo esc_url(get_option('wps_etmfw_mail_setting_upload_logo','')); ?>' style="width:<?php echo $wps_etmfw_logo_size.'px' ?>;margin-left: 25px"></td>
					...
					<tr>
						<td>
							<table style="width: 80%; padding: 15px 15px; border-right: dashed 2px #ffffff; margin: 0 auto">
								<tr>
									<td colspan="2">
										<h1 class="wps_etmfw_pdf_text_colour" style="margin: 0; font-size: 24px; color: <?php echo esc_attr( $wps_etmfw_text_color ); ?>; text-align: center;">Album JIO</h1>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<p class="wps_etmfw_pdf_text_colour" style="margin: 0; margin-top: 10px; margin-bottom: 10px; color:<?php echo esc_attr( $wps_etmfw_text_color ); ?>; font-size: 16px; text-align: center;">Venue- <span class="wps_etmfw_pdf_text_colour" style="color:<?php echo esc_attr( $wps_etmfw_text_color ); ?>">Delhi</span></p>
									</td>
								</tr>
								<tr>
								...
								<?php if ( 'on' == get_option( 'wps_etmfwp_include_qr') ) { ?>
									<td colspan="2">
										<p class="wps_etmfw_pdf_text_colour" style="margin: 0; margin-top: 10px; color:<?php echo esc_attr( $wps_etmfw_text_color ); ?>; font-size: 16px; text-align: center;">Ticket- <span class="wps_etmfw_pdf_text_colour" style="color:<?php echo esc_attr( $wps_etmfw_text_color ); ?>;">7ENBI</span></p>
									</td>
									<?php } ?>
								</tr>
							</table>
