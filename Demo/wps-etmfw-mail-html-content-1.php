					...
					<table style="width: 100%; padding: 15px 15px; border-right: dashed 2px #B3B9C2;">
						<tr>
							<td colspan="2">
								...
								<p style="margin: 0; margin-top: 10px; margin-bottom: 10px; color: <?php echo esc_attr( $text_color ); ?>; font-size: 16px;">Venue- <span style="color:<?php echo esc_attr( $text_color ); ?>">Delhi</span></p>
							</td>
						</tr>
						<tr>
						...
						<tr>
						<?php if ( false == $wps_is_qr_is_enable ) { ?>
							<td colspan="2" style="border-top: #C4CDD5 solid 2px; padding-top: 10px;">
								<p style="margin: 0; margin-top: 10px; color: <?php echo esc_attr( $text_color ); ?>; font-size: 16px;">Ticket- <span style="color:<?php echo esc_attr( $text_color ); ?>">7ENBI</span></p>
							</td>
							<?php } ?>
						</tr>
					</table>
