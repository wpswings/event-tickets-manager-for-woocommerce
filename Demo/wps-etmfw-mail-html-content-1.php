...
<body style="background-color: #ffffff; margin: 0; box-sizing: border-box;">
  <table class="wps_etmfw_border_color wps_etmfw_ticket_body" id = "wps_etmfw_parent_wrapper" class="wps_etmfw_ticket_body" cellspacing="0" cellpadding="0" style="width: 900px; background-color: <?php echo esc_attr( $wps_etmfw_background_color ); ?>; margin: 0 auto;border:2px <?php echo get_option('wps_etmfw_border_type').' ' . get_option('wps_etmfw_pdf_border_color'); ?>">
	<tbody>
	  <tr>
		<td style="width: 25%; padding: 15px; box-sizing: border-box;"><img id="wps_wem_logo_id" class="wps_wem_logo" src="<?php echo esc_url(get_option('wps_etmfw_mail_setting_upload_logo','')); ?>" style="width:<?php echo $wps_etmfw_logo_size.'px' ?>;margin-left: 25px"></td>
